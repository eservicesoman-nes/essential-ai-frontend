...
async function loadApiCredits(){
  ...
  html+=`<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-bottom:20px;">
    <div style="background:var(--surface);border-radius:8px;padding:12px;border:1px solid var(--border);"><div style="font-size:.7rem;color:var(--muted);margin-bottom:4px;font-family:var(--mono);">APIs monitored</div><div style="font-size:1.4rem;font-weight:700;color:var(--text);">${apis.length}</div></div>
    <div style="background:var(--surface);border-radius:8px;padding:12px;border:1px solid var(--border);"><div style="font-size:.7rem;color:var(--muted);margin-bottom:4px;font-family:var(--mono);">Alerts active</div><div style="font-size:1.4rem;font-weight:700;color:${alertCount>0?'#f85149':'#3fb950'};">${alertCount}</div></div>
    <div style="background:var(--surface);border-radius:8px;padding:12px;border:1px solid var(--border);"><div style="font-size:.7rem;color:var(--muted);margin-bottom:4px;font-family:var(--mono);">Auto-recharge</div><div style="font-size:1.4rem;font-weight:700;color:#7f77dd;">${Object.values(thresholds).filter(t=>t.recharge_amount>0).length}</div></div>
    <div style="background:var(--surface);border-radius:8px;padding:12px;border:1px solid var(--border);"><div style="font-size:.7rem;color:var(--muted);margin-bottom:4px;font-family:var(--mono);">Est. monthly</div><div style="font-size:1.4rem;font-weight:700;color:var(--nes-blue);">~$25</div></div>
  </div>`;
  ...
  apis.forEach(function(api){
    ...
    html+=`<div style="background:var(--surface);border:1px solid ${status==='low'?'rgba(248,81,73,.3)':'var(--border)'};border-radius:12px;padding:14px 16px;">
      ...
      <div style="font-size:.68rem;color:var(--muted);font-family:var(--mono);margin-bottom:10px;">Current balance</div>
      <div style="display:flex;justify-content:space-between;font-size:.65rem;color:var(--muted);font-family:var(--mono);margin-bottom:4px;"><span>Used this month</span><span>$${usage.toFixed(2)}</span></div>
